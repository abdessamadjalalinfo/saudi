...
<li class="u-nav-item"><a class="u-button-style u-custom-color-8 u-hover-custom-color-3 u-nav-link u-text-hover-custom-color-2">{{$categorie->name}}</a>
</li>
@endforeach
</ul>
...
@endif</ul>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="{{route('profile')}}" style="padding: 10px 0px;">Profile</a>
   ...
   <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
       @csrf
   </form> </span> <section class="u-clearfix u-white u-section-1" id="sec-2654">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-custom-font u-font-georgia u-subtitle u-text u-text-default u-text-1">{{$name}}</h2>
        <div class="u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            @foreach($files as $file)
            <div class="u-container-style u-list-item u-repeater-item u-video-cover u-white">
              <div class="u-container-layout u-similar-container u-container-layout-1">
                <h3 class="u-custom-font u-custom-item u-font-roboto-slab u-text u-text-default u-text-2">{{$file->name}}</h3>
                ...
                <a href="{{$file->path}}" target='_blank'
                    ><img class="u-image u-image-default u-image-1" src="ff.png" alt=""></a>  
               
                
                <a href="{{$file->path}}" target='_blank' class="u-border-2 u-border-custom-color-2 u-btn u-btn-round u-button-style u-custom-font u-font-roboto-slab u-hover-custom-color-2 u-none u-radius-47 u-text-black u-btn-1">View</a>
              </div>
            </div>
            @endforeach
