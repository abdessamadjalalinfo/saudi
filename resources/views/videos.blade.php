   ...
   <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
    ...
    <section class="u-clearfix u-white u-section-1" id="sec-2654">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-custom-font u-font-georgia u-subtitle u-text u-text-default u-text-1">Videos</h2>
        <div class="u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            @foreach($videos as $video)
            <div class="u-container-style u-list-item u-repeater-item u-video-cover u-white">
              <div class="u-container-layout u-similar-container u-container-layout-1">
                <h3 class="u-custom-font u-custom-item u-font-roboto-slab u-text u-text-default u-text-2">{{$video->name}}</h3>
                ...
                <video  class="u-image u-image-default u-image-1" controls>
                    <source src="{{$video->path}}" type="video/mp4">
                    <source src="{{$video->path}}" type="video/webm">
                    <p>Votre navigateur ne prend pas en charge les vidéos HTML5.
                       Voici <a href="{{$video->path}}">un lien pour télécharger la vidéo</a>.</p>
                  </video>
